...
import com.prograssoft.shahad.business.security.JwtAuthenticationFilter;
import com.prograssoft.shahad.business.security.JwtUtils;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtUtils jwtUtils(@Value("${security.jwt.secret-key}") String secret,
