...
public class PrivateSavingLimitStrategy implements WithdrawLimitStrategy {
    private final BigDecimal maximumLimit = BigDecimal.valueOf(4000);
...
return amount.compareTo(maximumLimit) <= 0;
    ...
    public Class<? extends Account> getAccountType() {
        return PrivateSavingAccount.class;
    }
}
